...
class NoteAddUpdateActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Uri yang didapatkan di sini akan digunakan untuk mengambil data dari provider
    ...
    override fun onClick(v: View?) {
        if (v?.id == R.id.btn_submit) {
            ...
            if (title.isEmpty()) {
                edt_title.error = "Kolom tidak boleh kosong"
                return
            }
...
//                    finish()
//                } else {
//                    Toast.makeText(this, "Gagal meng-update data", Toast.LENGTH_SHORT).show()
//                }
